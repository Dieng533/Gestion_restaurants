...
<table width="104%" height="1071" border="0" cellpadding="0" cellspacing="0">
	...
	<td width="58" valign="top" bgcolor="#6699FF"><img src="mm_spacer.gif" alt="" width="50" height="1" border="0" />
	  <table height="343" align="center">
        <tr valign="baseline">
          <td width="63" align="right" nowrap><div align="center"><strong><span class="Style5">Numero:</span></strong></div></td>
          <td width="268"><div align="center"><strong>
              <input name="NumClient" type="text" value="" size="32" />
          </strong></div></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="center"><strong><span class="Style5">Nom:</span></strong></div></td>
          <td><div align="center"><strong>
              <input name="NomClient" type="text" value="" size="32" />
          </strong></div></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="center"><strong><span class="Style5">Prenom:</span></strong></div></td>
          <td><div align="center"><strong>
              <input name="PrenomClient" type="text" value="" size="32" />
          </strong></div></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="center"><strong><span class="Style5">Telephone:</span></strong></div></td>
          <td><div align="center"><strong>
              <input name="Tel" type="text" value="" size="32" />
          </strong></div></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right"><div align="center"><strong><span class="Style5">Email:</span></strong></div></td>
          <td><div align="center"><strong>
              <input name="Email" type="text" value="" size="32" />
          </strong></div></td>
        </tr>
        <tr valign="baseline">
          <td height="157" align="right" nowrap>&nbsp;</td>
          <td><input name="submit" type="submit" value="Ins&eacute;rer un client" /></td>
        </tr>
      </table></td>
