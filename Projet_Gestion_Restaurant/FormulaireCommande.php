...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO commande (NumCommande, NumClient, NumPlat, Quantité, `Date`) VALUES (%s, %s, %s, %s, %s)",
...
<table width="127%" height="623" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFCC">
	...
	<td width="480" valign="top"><table align="center">
      ...
      <tr valign="baseline">
        <td align="right" nowrap class="pageName"><div align="center" class="Style2"><strong><span class="Style7">Quantité:</span></strong></div></td>
        <td><div align="center" class="Style2"><strong>
